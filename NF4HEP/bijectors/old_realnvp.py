...
class RealNVPBijector(tfb.Bijector, Verbosity):
    ...
    def __init__(self,
        ...
        self.verbose = verbose
        verbose, verbose_sub = self.get_verbosity(verbose)
        super().__init__(validate_args=model_bijector_inputs["validate_args"],
                         forward_min_event_ndims=model_bijector_inputs["forward_min_event_ndims"])
...
class RealNVPFlow(tfb.Chain, Verbosity):
    ...
    def __init__(self,
        ...
        bijector = RealNVPBijector(model_define_inputs, model_bijector_inputs)
        ...
        bijectors = []
        for _ in range(model_bijector_inputs["num_bijectors"]):
            if batch_norm:
